...
class QuantumOptimizationTests(unittest.TestCase):
    ...
    def test_simulated_annealing_solve(self) -> None:
        ...
        x_sol, energy = self.q_opt.solve_simulated_annealing(num_reads=2, num_sweeps=100)
    ...
    def test_end_to_end_quantum_run(self) -> None:
        ...
        self.assertGreater(summary["total_defects_scheduled"], 35)
        self.assertEqual(summary["p1_immediate_clearance_pct"], 100.0)
        self.assertGreaterEqual(summary["p2_urgent_clearance_pct"], 85.0)
