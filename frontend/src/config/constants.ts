...
export const DEPARTMENTS_INFO = {
  Engineering: {
    ...
    color: '#3E6C8A',
    badgeClass: 'bg-[var(--accent-steel-bg)] text-[var(--accent-steel-light)] border border-[var(--accent-steel-border)]',
  ...
  TRD: {
    ...
    color: '#E8A33D',
    badgeClass: 'bg-[var(--accent-amber-bg)] text-[var(--accent-amber-light)] border border-[var(--accent-amber-border)]',
  ...
  'S&T': {
    ...
    color: '#2E8B57',
    badgeClass: 'bg-[var(--accent-green-bg)] text-[var(--accent-green-light)] border border-[var(--accent-green-border)]',
